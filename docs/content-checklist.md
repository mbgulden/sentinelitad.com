# Content and Asset Collection Checklist
...
- [ ] Add downloadable one-page PDF/flyer for MSP feeder-bin outreach.

## Compliance-safe copy rules

- [ ] Do not claim Sentinel is R2v3 certified unless Sentinel itself is certified.
- [ ] Do not claim certified data destruction until tooling/process/certificate trail exists.
- [ ] Say “downstream certified partner” only when partner evidence is on file.
- [ ] Say “NIST 800-88 aligned” only for actual wipe/destruction events that follow the documented process.
- [ ] Keep aspirational features out of public copy until operational.

## Local SEO expansion

- [ ] Service page: IT asset disposal Boise.
- [ ] Service page: ITAD Meridian Idaho.
- [ ] Service page: server recycling Boise.
- [ ] Service page: hard-drive destruction Boise.
- [ ] Service page: MSP e-waste pickup Treasure Valley.
- [ ] Google Business Profile setup after public contact/address policy is decided.
